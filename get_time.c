...
void printTable(unsigned int table[],unsigned int size);
...
bool leapYearChecker(unsigned int start, unsigned int end){
	...
	printTable(leapYearCheckTable, leapYearTableSize);
	cout << endl;
	...
	printTable(calculatedLeapYearTable, calculatedLeapYearTableIndex);
	cout << endl;
